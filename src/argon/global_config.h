...
#define ARGON_PLATFORM_RENDERING_BACKEND_LINUX ARGON_RENDERING_BACKEND_OPENGL
#define ARGON_PLATFORM_RENDERING_BACKEND_MACOSX ARGON_RENDERING_BACKEND_OPENGL
